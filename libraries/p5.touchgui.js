...
class GuiStyle { 
  ...
  // custome style for app by MEEEE
  customStyle() {
    ...
    // global color styls
    this.gStrokeColor = color(0)
    this.fontFill = color(0)
    ...
    this.button = {
      ...
      textSize:           20, 
      fillBg:             color(0,0),
      fillBgHover:        color(0,0),
      fillBgActive:       color(0,0),
      fillLabel:          this.fontFill,
      fillLabelHover:     this.fontFill,
      fillLabelActive:    this.fontFill,
      strokeBg:           this.gStrokeColor,
      strokeBgHover:      this.gStrokeColor,
      strokeBgActive:     this.gStrokeColor,
    };
    ...
    this.toggle = {
      ...
      textSize:           20, 
      fillBgOff:          color(0,0),
      fillBgOffHover:     color(0,0),
      fillBgOffActive:    color(0,0),
      fillBgOn:           color(0,0),
      fillBgOnHover:      color(0,0), 
      fillBgOnActive:     color(0,0),
      fillLabelOff:       this.fontFill,
      fillLabelOffHover:  this.fontFill,
      fillLabelOffActive: this.fontFill,
      fillLabelOn:        this.fontFill,
      fillLabelOnHover:   this.fontFill,
      fillLabelOnActive:  this.fontFill,
      strokeBgOff:        this.gStrokeColor,
      strokeBgOffHover:   this.gStrokeColor,
      strokeBgOffActive:  this.gStrokeColor,
      strokeBgOn:         this.gStrokeColor,
      strokeBgOnHover:    this.gStrokeColor,
      strokeBgOnActive:   this.gStrokeColor,
    }
    ...
    this.slider = {
      ...
      fillBgActive:       color(0,0),
      fillTrack:          color(0,0), 
      fillTrackHover:     color(0,0), 
      fillTrackActive:    color(0,0), 
      fillHandle:         color(0), 
      fillHandleHover:    color(0), 
      fillHandleActive:   color(0), 
      strokeBg:           this.gStrokeColor, 
      strokeBgHover:      this.gStrokeColor, 
      strokeBgActive:     this.gStrokeColor, 
      strokeTrack:        this.gStrokeColor, 
      strokeTrackHover:   this.gStrokeColor, 
      strokeTrackActive:  this.gStrokeColor,
      strokeHandle:       this.gStrokeColor, 
      strokeHandleHover:  this.gStrokeColor, 
      strokeHandleActive: this.gStrokeColor,
    }
    
    this.crossfader = {
      strokeCenter:       this.gStrokeColor,
      strokeCenterHover:  this.gStrokeColor,
      strokeCenterActive: this.gStrokeColor,
    }
